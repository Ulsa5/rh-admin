        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <h4>Listado de Tipos de Sangre</h4>
                            <br>
                            <a href="{{ route('bloods.create') }}" class="btn btn-primary mt-2 mb-2">
                    ...
                    <table id="tabla" class="stripe hover order-colum row-border text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $blood->comment }}</td>
                                <td>
                                    <a href="{{ route('bloods.edit', $blood) }}" class="btn btn-success">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ route('bloods.destroy', $blood) }}" method="POST" class="d-inline formulario-eliminar">
                                        @csrf
                                        @method('DELETE')
