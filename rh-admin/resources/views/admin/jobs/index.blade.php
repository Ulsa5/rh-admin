        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <h4>Listado de Puestos</h4>
                            <br>
                            <a href="{{ route('jobs.create') }}" class="btn btn-primary mt-2 mb-2">
                    ...
                    <table id="tabla" class="stripe hover order-colum row-border text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('jobs.edit', $job) }}" class="btn btn-success">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ route('jobs.destroy', $job) }}" method="POST" class="d-inline formulario-eliminar">
                                        @csrf
                                        @method('DELETE')
