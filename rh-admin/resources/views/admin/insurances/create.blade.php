        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <h4>Agregar Seguro de Vida</h4>
                        </div>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{route('insurances.store')}}" method="POST" class="d-inline" id="form-alta">
                        @csrf

                        <div class="form-group row mt-4">
                            <label for="name" class="col-sm-2 col-form-label">Nombre del Seguro:</label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" id="name" rows="4" tabindex="1" autofocus></input>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="company" id="company" tabindex="2">
